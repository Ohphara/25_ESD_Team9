...
class Model(nn.Module):
    ...
    def forward(self, v_0):
        ...
        return v_238
        v_239, v_240 = torch.split(tensor=v_238, dim=1, split_size_or_sections=(64,80))
        v_241 = v_239.view(1, 4, 16, 8400)
        v_242 = torch.transpose(input=v_241, dim0=2, dim1=1)
        v_243 = F.softmax(input=v_242, dim=1)
        v_244 = self.model_23_dfl_conv(v_243)
        v_245 = v_244.view(1, 4, 8400)
        v_246 = self.pnnx_fold_anchor_points_1_data
        v_247 = self.pnnx_fold_anchor_points_1_1_data
        v_248, v_249 = torch.chunk(input=v_245, chunks=2, dim=1)
        v_250 = (v_246 - v_248)
        v_251 = (v_247 + v_249)
        v_252 = ((v_250 + v_251) / 2)
        v_253 = (v_251 - v_250)
        ...
        v_255 = (v_254 * v_189)
        v_256 = F.sigmoid(input=v_240)
        v_257 = torch.cat((v_255, v_256), dim=1)
        return v_257
